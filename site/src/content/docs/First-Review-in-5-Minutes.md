...
## Step 1: Pick One Note

Choose one note you already understand well enough to test the workflow.

Do not start by migrating your whole vault.

## Step 2: Add 3 To 5 Flashcards
...
Your first session is successful if:

- your flashcards appear
- you can reveal and grade them
- LearnKit records progress without errors

That is enough to prove your setup works.
