...
If the source note is wrong, fix the source note.

If the flashcard is correct in principle but needs a quick cleanup, editing during review or in Flashcard Library is often enough.
