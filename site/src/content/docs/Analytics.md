...
At the top of the page, LearnKit lets you switch between three analytics sections:
...
The `Flashcards` section starts with four summary cards:
...
The `Notes` section focuses on note review activity rather than flashcard reviews.
...
The `Tests` section tracks exam and test attempts.
