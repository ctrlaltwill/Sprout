...
- You write in notes.
- LearnKit reads supported flashcard content from those notes.
- Sync updates the study database.
- FSRS schedules what to review next.
- Review results improve the next schedule.

## Recommended First Session

Start small on day one.

1. Pick one note.
2. Add 5 to 10 flashcards.
3. Run sync.
4. Open a study session.
5. Finish one complete review round.

That is enough to verify your setup and understand the basic loop.
