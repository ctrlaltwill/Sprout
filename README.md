...
> **Release 1.0.2** — pending Obsidian community approval; includes 1.0.0 core features (FSRS scheduler, card types, analytics, editor/browser, reading view cards) and 1.0.1 Anki import/export plus hotfixes.
