...
import { VIEW_TYPE_REVIEWER, VIEW_TYPE_WIDGET, VIEW_TYPE_STUDY_ASSISTANT, VIEW_TYPE_BROWSER, VIEW_TYPE_NOTE_REVIEW, VIEW_TYPE_ANALYTICS, VIEW_TYPE_HOME, VIEW_TYPE_SETTINGS, VIEW_TYPE_EXAM_GENERATOR, VIEW_TYPE_COACH, LEGACY_VIEW_TYPE_REVIEWER, LEGACY_VIEW_TYPE_WIDGET, LEGACY_VIEW_TYPE_STUDY_ASSISTANT, LEGACY_VIEW_TYPE_BROWSER, LEGACY_VIEW_TYPE_ANALYTICS, LEGACY_VIEW_TYPE_HOME, LEGACY_VIEW_TYPE_SETTINGS, LEGACY_VIEW_TYPE_EXAM_GENERATOR, LEGACY_VIEW_TYPE_COACH, LEGACY_TO_CURRENT_VIEW_TYPES, BRAND, DEFAULT_SETTINGS, deepMerge, } from "../core/constants";
...
import { initialiseDedicatedApiKeyStorage, initialiseDedicatedTtsApiKeyStorage, migrateLegacyConfigFiles, } from "../core/settings-storage";
...
export function WithLifecycleMethods(Base) {
    return class WithLifecycleMethods extends Base {
            ...
            this.addCommand({
                ...
                checkCallback: (checking) => {
                    ...
                    if (!((_b = (_a = this.settings) === null || _a === void 0 ? void 0 : _a.studyAssistant) === null || _b === void 0 ? void 0 : _b.enabled))
                        return false;
                    if (!checking)
                        void this.openAssistantWidgetSafe();
                    return true;
                },
            });
        ...
        async onload() {
            ...
            try {
                ...
                (_a = this._disposeTooltipPositioner) === null || _a === void 0 ? void 0 : _a.call(this);
                ...
                await migrateLegacyConfigFiles({
                    adapter: (_c = (_b = this.app) === null || _b === void 0 ? void 0 : _b.vault) === null || _c === void 0 ? void 0 : _c.adapter,
                    getConfigFilePath: (filename) => this._getConfigFilePath(filename),
                ...
                await initialiseDedicatedApiKeyStorage({
                    adapter: (_e = (_d = this.app) === null || _d === void 0 ? void 0 : _d.vault) === null || _e === void 0 ? void 0 : _e.adapter,
                    dirPath: this._getConfigDirPath(),
                    filePath: this._getApiKeysFilePath(),
                    settings: this.settings,
                });
                await initialiseDedicatedTtsApiKeyStorage({
                    adapter: (_g = (_f = this.app) === null || _f === void 0 ? void 0 : _f.vault) === null || _g === void 0 ? void 0 : _g.adapter,
                    dirPath: this._getConfigDirPath(),
                ...
                // Wire vault adapter into TTS service for external provider caching
                {
                    ...
                    tts.vaultAdapter = (_k = (_j = (_h = this.app) === null || _h === void 0 ? void 0 : _h.vault) === null || _j === void 0 ? void 0 : _j.adapter) !== null && _k !== void 0 ? _k : null;
                    const configDir = (_m = (_l = this.app) === null || _l === void 0 ? void 0 : _l.vault) === null || _m === void 0 ? void 0 : _m.configDir;
                    const pluginId = (_o = this.manifest) === null || _o === void 0 ? void 0 : _o.id;
                    if (configDir && pluginId) {
                        tts.ttsCacheDirPath = getTtsCacheDirPath(configDir, pluginId);
                    }
                }
                this._registerSproutPinchZoom();
                setDelimiter((_p = this.settings.indexing.delimiter) !== null && _p !== void 0 ? _p : "|");
                ...
                if (!(this.store instanceof SqliteStore) && !this.store.loadedFromDisk && isPlainObject(root)) {
                    log.warn("data.json existed but contained no .store - initial save will be guarded by assessPersistSafety.");
                }
                ...
                this.registerView(VIEW_TYPE_SETTINGS, (leaf) => new LearnKitSettingsView(leaf, this));
                ...
                this.registerView(LEGACY_VIEW_TYPE_REVIEWER, (leaf) => new SproutReviewerView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_WIDGET, (leaf) => new SproutWidgetView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_STUDY_ASSISTANT, (leaf) => new SproutStudyAssistantView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_BROWSER, (leaf) => new SproutCardBrowserView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_ANALYTICS, (leaf) => new SproutAnalyticsView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_HOME, (leaf) => new SproutHomeView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_SETTINGS, (leaf) => new LearnKitSettingsView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_EXAM_GENERATOR, (leaf) => new SproutExamGeneratorView(leaf, this));
                this.registerView(LEGACY_VIEW_TYPE_COACH, (leaf) => new SproutCoachView(leaf, this));
                ...
                this.registerEvent(this.app.workspace.on("active-leaf-change", (leaf) => {
                    var _a;
                    this._updateStatusBarVisibility(leaf !== null && leaf !== void 0 ? leaf : null);
                    (_a = this._assistantPopup) === null || _a === void 0 ? void 0 : _a.onActiveLeafChange();
                }));
                this.registerEvent(this.app.workspace.on("file-open", (file) => {
                    var _a;
                    const f = file instanceof TFile ? file : null;
                    (_a = this._assistantPopup) === null || _a === void 0 ? void 0 : _a.onFileOpen(f);
                    this.app.workspace
                        .getLeavesOfType(VIEW_TYPE_WIDGET)
                        .forEach((leaf) => { var _a, _b; return (_b = (_a = leaf.view) === null || _a === void 0 ? void 0 : _a.onFileOpen) === null || _b === void 0 ? void 0 : _b.call(_a, f); });
                    this.app.workspace
                ...
                this.registerEvent(this.app.vault.on("rename", (file, oldPath) => {
                    ...
                    if (file instanceof TFile && file.path.toLowerCase().endsWith(".md")) {
                        void ((_a = this._assistantPopup) === null || _a === void 0 ? void 0 : _a.onFileRename(oldPath, file));
                    }
                }));
                this.app.workspace.onLayoutReady(() => {
                    ...
                    (_a = this._reminderEngine) === null || _a === void 0 ? void 0 : _a.start();
                });
                await this.saveAll();
        ...
        onunload() {
            var _a, _b, _c, _d;
            const pending = (_a = this._saving) !== null && _a !== void 0 ? _a : Promise.resolve();
            void pending
                .then(() => this._doSave())
            ...
            (_b = this._disposeTooltipPositioner) === null || _b === void 0 ? void 0 : _b.call(this);
            ...
            (_c = this._reminderEngine) === null || _c === void 0 ? void 0 : _c.stop();
            this._reminderEngine = null;
            teardownReadingView();
            removeAosErrorHandler();
            cleanupMobileKeyboardHandler();
            (_d = this._assistantPopup) === null || _d === void 0 ? void 0 : _d.destroy();
