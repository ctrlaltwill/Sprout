...
export function detectLanguage(text) {
    ...
    for (const rule of SCRIPT_RULES) {
        ...
        const count = (_a = matches === null || matches === void 0 ? void 0 : matches.length) !== null && _a !== void 0 ? _a : 0;
        if (count > bestCount) {
            bestCount = count;
            bestLang = rule.lang;
        }
 ...
 */
export function getBlankWord(lang) {
    var _a;
    if (!lang)
        return "blank";
    // Try exact match first, then primary subtag (e.g. "en-US" → "en")
    const primary = lang.split("-")[0].toLowerCase();
    return (_a = BLANK_WORD_MAP[primary]) !== null && _a !== void 0 ? _a : "blank";
}
