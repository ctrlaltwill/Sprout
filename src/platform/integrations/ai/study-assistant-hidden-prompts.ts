...
const FLASHCARD_HIDDEN_RULES = [
  ...
  "Schema: {\"suggestions\":[{\"type\":\"basic|reversed|cloze|mcq|oq|io\",\"difficulty\":1-3,\"title\":\"optional\",\"question\":\"optional\",\"answer\":\"optional\",\"clozeText\":\"optional\",\"options\":[\"...\"],\"correctOptionIndexes\":[0],\"steps\":[\"...\"],\"ioSrc\":\"optional\",\"ioOcclusions\":[{\"rectId\":\"r1\",\"x\":0.1,\"y\":0.2,\"w\":0.2,\"h\":0.08,\"groupKey\":\"1\",\"shape\":\"rect\"}],\"ioMaskMode\":\"solo|all\",\"ioAssessment\":{\"imageRef\":\"optional\",\"imageKind\":\"diagram|annotated-photo|chart|table|map|flowchart|photo|clinical-photo|screenshot|other\",\"studyValue\":\"high|medium|low|none\",\"placementConfidence\":0.0,\"targetLabels\":[\"...\"],\"usefulnessReason\":\"optional\"},\"info\":\"optional\",\"groups\":[\"optional/group\"],\"noteRows\":[\"KIND | value |\"],\"rationale\":\"optional\"}]}",
