...
export const SPROUT_TITLE_STRIP_LABEL_CLASS = `learnkit-view-title-strip-label ${SPROUT_TITLE_TEXT_CLASS}`;
export const SPROUT_HOME_CONTENT_SHELL_CLASS = "learnkit-view-content-shell lk-home-content-shell";
