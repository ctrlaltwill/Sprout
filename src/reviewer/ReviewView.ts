...
import { renderClozeFront } from "./QuestionCloze";
import { renderDeckMode } from "./RenderDeck";
import { renderSessionMode } from "./RenderSession";
import { initAOS } from "../core/aos-loader";

import { openSproutImageZoom } from "./Zoom";
import { SproutMarkdownHelper } from "./MarkdownRender";
...
import { logFsrsIfNeeded, logUndoIfNeeded } from "./FSRSLog";
import { renderTitleMarkdownIfNeeded } from "./TitleMarkdown";
import { keybox, makePlainButton, appendKeyboxRight } from "./UI";
import { findCardBlockRangeById, buildCardBlockMarkdown } from "./MarkdownBlock";

import type { CardState } from "../core/store";

import { deepClone, clampInt } from "./Utilities";
import { matchesScope } from "../indexes/scopeMatch";

import * as IO from "../imageocclusion/ImageOcclusionIndex";
import {
  isIoParentCard,
  isIoRevealableType,
  renderImageOcclusionReviewInto,
} from "../imageocclusion/ImageOcclusionReviewRender";
