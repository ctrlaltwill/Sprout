...
const tx = (interfaceLanguage, token, fallback, vars) => t(interfaceLanguage, token, fallback, vars);
/**
 ...
 */
export function renderStudySessionHeader(container, interfaceLanguage, applyAOS, options) {
    var _a, _b, _c, _d;
    // Check if header already exists
    let studySessionHeader = queryFirst(container, "[data-study-session-header]");
    ...
    studySessionLabel.textContent = tx(interfaceLanguage, (_a = options === null || options === void 0 ? void 0 : options.titleToken) !== null && _a !== void 0 ? _a : "ui.reviewer.session.header.title", (_b = options === null || options === void 0 ? void 0 : options.titleFallback) !== null && _b !== void 0 ? _b : "Study session");
    ...
    (_c = queryFirst(playIconWrap, "svg")) === null || _c === void 0 ? void 0 : _c.classList.add("shrink-0");
    ...
    (_d = queryFirst(pauseIconWrap, "svg")) === null || _d === void 0 ? void 0 : _d.classList.add("shrink-0");
    ...
    const syncTimerControlState = (_btn) => {
