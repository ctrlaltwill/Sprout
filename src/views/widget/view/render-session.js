...
import { makeTextButton, applyWidgetActionButtonStyles, applyWidgetHoverDarken, attachWidgetMoreMenu, } from "../ui/widget-buttons";
...
function questionNumberWithinNote(view, card) {
    var _a;
    const currentId = String(card.id || "");
    const sourcePath = String(card.sourceNotePath || "").trim().toLowerCase();
    if (!sourcePath)
        return 1;
    const noteCards = (((_a = view.session) === null || _a === void 0 ? void 0 : _a.queue) || [])
...
function fallbackWidgetTitle(view, card) {
    var _a;
    const page = pageNameFromSourcePath(String(card.sourceNotePath || ((_a = view.activeFile) === null || _a === void 0 ? void 0 : _a.path) || ""));
 ...
 */
export function renderWidgetSession(view, root) {
    ...
    const scopeLabel = ((_a = view.session) === null || _a === void 0 ? void 0 : _a.scopeType) === "folder"
        ? tx(view, "ui.widget.scope.folder", "Folder")
        : tx(view, "ui.widget.scope.note", "Note");
    const studyingScope = `${((_b = view.session) === null || _b === void 0 ? void 0 : _b.scopeName) || tx(view, "ui.widget.scope.note", "Note")} ${scopeLabel}`;
    const studyingTitle = el("div", "sprout-widget-study-label", tx(view, "ui.widget.studyingScope", "Studying {scope}", { scope: studyingScope }));
    const remainingCount = Math.max(0, (((_c = view.session) === null || _c === void 0 ? void 0 : _c.stats.total) || 0) - (((_d = view.session) === null || _d === void 0 ? void 0 : _d.stats.done) || 0));
    ...
    const cardId = String((_f = (_e = (card)) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : "");
    ...
    if (!card) {
        ...
        body.appendChild(el("div", "text-lg font-semibold text-foreground sprout-widget-session-complete-title", tx(view, "ui.widget.sessionComplete", "Session Complete!")));
        body.appendChild(el("div", "text-sm text-muted-foreground sprout-widget-session-complete-meta", tx(view, "ui.widget.reviewedProgress", "Reviewed: {done}/{total}", {
            done: ((_h = (_g = view.session) === null || _g === void 0 ? void 0 : _g.stats) === null || _h === void 0 ? void 0 : _h.done) || 0,
            total: ((_k = (_j = view.session) === null || _j === void 0 ? void 0 : _j.stats) === null || _k === void 0 ? void 0 : _k.total) || 0,
        })));
    ...
    const graded = ((_l = view.session) === null || _l === void 0 ? void 0 : _l.graded[id]) || null;
    // ---- Body: card content -------------------------------------------
    const body = el("div", "card sprout-widget-card-body");
    const applySectionStyles = (e) => {
    ...
    if (TYPE_LABELS.has(cardTitle.toLowerCase()))
        cardTitle = "";
    ...
    const infoText = String((_o = (_m = (card)) === null || _m === void 0 ? void 0 : _m.info) !== null && _o !== void 0 ? _o : "").trim();
...
/* ================================================================== */
function renderBasicCard(view, body, card, graded, infoText, applySectionStyles) {
    var _a, _b;
    const qActions = el("div", "flex items-center justify-end gap-2");
    appendWidgetTtsReplayButton(view, qActions, card, graded, false);
    if (qActions.childElementCount > 0)
        body.appendChild(qActions);
    ...
    if (qText.includes("$") || qText.includes("[[") || qText.includes("\\(") || qText.includes("\\[") || hasMarkdownTable(qText) || hasMarkdownList(qText)) {
        ...
        const sourcePath = String(card.sourceNotePath || ((_a = view.activeFile) === null || _a === void 0 ? void 0 : _a.path) || "");
    ...
    if (view.showAnswer || graded) {
        ...
        if (aActions.childElementCount > 0)
        ...
        if (aText.includes("$") || aText.includes("[[") || aText.includes("\\(") || aText.includes("\\[") || hasMarkdownTable(aText) || hasMarkdownList(aText)) {
            ...
            const sourcePath = String(card.sourceNotePath || ((_b = view.activeFile) === null || _b === void 0 ? void 0 : _b.path) || "");
...
function isWidgetTtsEnabled(view) {
    const audio = view.plugin.settings.audio;
    if (!(audio === null || audio === void 0 ? void 0 : audio.enabled))
        return false;
    if (audio.widgetReplay === false)
        return false;
    return getTtsService().isSupported;
}
function appendWidgetTtsReplayButton(view, parent, card, graded, answerSide) {
    if (!isWidgetTtsEnabled(view))
        return;
...
function renderClozeCard(view, body, card, graded, infoText, applySectionStyles) {
    ...
    if (text.includes("$") || text.includes("\\(") || text.includes("\\[") || text.includes("[[") || hasMarkdownTable(text) || hasMarkdownList(text)) {
        ...
        const sourcePath = String(card.sourceNotePath || ((_a = view.activeFile) === null || _a === void 0 ? void 0 : _a.path) || "");
        const clozeMode = (_c = (_b = view.plugin.settings.cards) === null || _b === void 0 ? void 0 : _b.clozeMode) !== null && _c !== void 0 ? _c : "standard";
        const clozeBgColor = (_e = (_d = view.plugin.settings.cards) === null || _d === void 0 ? void 0 : _d.clozeBgColor) !== null && _e !== void 0 ? _e : "";
        const clozeTextColor = (_g = (_f = view.plugin.settings.cards) === null || _f === void 0 ? void 0 : _f.clozeTextColor) !== null && _g !== void 0 ? _g : "";
        const clozeOpts = {
            mode: clozeMode,
            clozeBgColor,
            clozeTextColor,
            typedAnswers: view._typedClozeAnswers,
            onTypedInput: (answerKey, _clozeIndex, value) => {
        ...
        const clozeMode = (_j = (_h = view.plugin.settings.cards) === null || _h === void 0 ? void 0 : _h.clozeMode) !== null && _j !== void 0 ? _j : "standard";
        const clozeBgColor = (_l = (_k = view.plugin.settings.cards) === null || _k === void 0 ? void 0 : _k.clozeBgColor) !== null && _l !== void 0 ? _l : "";
        const clozeTextColor = (_n = (_m = view.plugin.settings.cards) === null || _m === void 0 ? void 0 : _m.clozeTextColor) !== null && _n !== void 0 ? _n : "";
...
function renderMcqCard(view, body, card, graded, infoText, applySectionStyles) {
    var _a, _b, _c, _d;
    ...
    const chosen = (_b = graded === null || graded === void 0 ? void 0 : graded.meta) === null || _b === void 0 ? void 0 : _b.mcqChoice;
    const chosenMulti = ((_c = graded === null || graded === void 0 ? void 0 : graded.meta) === null || _c === void 0 ? void 0 : _c.mcqChoices)
        ? new Set(graded.meta.mcqChoices)
        : new Set();
    ...
    const randomize = !!((_d = view.plugin.settings.study) === null || _d === void 0 ? void 0 : _d.randomizeMcqOptions);
    ...
    if (isMulti && view._mcqMultiCardId !== String(card.id)) {
        view._mcqMultiSelected = new Set();
        ...
        if (!graded) {
            if (isMulti) {
                ...
                d.addEventListener("click", () => {
                    if (view._mcqMultiSelected.has(origIdx))
                        view._mcqMultiSelected.delete(origIdx);
                    else
                        view._mcqMultiSelected.add(origIdx);
                    view.render();
                });
            }
            else {
...
function renderIoCard(view, body, card, graded, infoText, applySectionStyles) {
    var _a;
    const reveal = view.showAnswer || !!graded;
...
function ensureWidgetOqOrderMap(session) {
    if (!session.oqOrderMap || typeof session.oqOrderMap !== "object")
        session.oqOrderMap = {};
    return session.oqOrderMap;
}
...
function getWidgetOqShuffledOrder(session, card, enabled) {
    var _a;
...
function renderOqCard(view, body, card, graded, infoText, applySectionStyles) {
    var _a, _b, _c;
    ...
    if (!reveal) {
        ...
        const shouldShuffle = (_c = (_b = view.plugin.settings.study) === null || _b === void 0 ? void 0 : _b.randomizeOqOrder) !== null && _c !== void 0 ? _c : true;
        const shuffled = getWidgetOqShuffledOrder(view.session, card, shouldShuffle);
        ...
        const commitReorder = (fromIdx, toIdx) => {
            ...
            const oqMap = ensureWidgetOqOrderMap(view.session);
...
/*  Info block helper                                                  */
/* ================================================================== */
function renderInfoBlock(body, infoText, applySectionStyles, view, card) {
    var _a;
    ...
    if (view && (hasMarkdownTable(normalizedInfoText) || hasMarkdownList(normalizedInfoText))) {
        ...
        const sourcePath = String((card === null || card === void 0 ? void 0 : card.sourceNotePath) || ((_a = view.activeFile) === null || _a === void 0 ? void 0 : _a.path) || "");
...
/*  Footer renderers                                                   */
/* ================================================================== */
function renderPracticeFooter(view, footer, card, ioLike) {
...
function renderScheduledFooter(view, footer, card, graded, ioLike) {
...
function speakWidgetCard(view, card, graded, forceAnswerSide) {
    var _a, _b, _c;
    const tts = getTtsService();
    const audio = view.plugin.settings.audio;
    if (!(audio === null || audio === void 0 ? void 0 : audio.enabled) || audio.widgetReplay === false || !tts.isSupported)
        return;
    ...
    if (card.type === "mcq") {
        const options = normalizeCardOptions(card.options);
        const randomize = !!((_a = view.plugin.settings.study) === null || _a === void 0 ? void 0 : _a.randomizeMcqOptions);
        const order = getWidgetMcqDisplayOrder(view.session, card, randomize);
    ...
    if (card.type === "oq") {
        const steps = Array.isArray(card.oqSteps) ? card.oqSteps : [];
        if (reveal) {
            const pass = !!((_b = graded === null || graded === void 0 ? void 0 : graded.meta) === null || _b === void 0 ? void 0 : _b.oqPass);
            tts.speakOqAnswer(steps, pass, audio, `${cid}-${pass ? "pass" : "fail"}`);
        }
        else {
            const s = view.session;
            const order = (_c = s === null || s === void 0 ? void 0 : s.oqOrderMap) === null || _c === void 0 ? void 0 : _c[String(card.id)];
...
function maybeAutoSpeakWidgetCard(view, card, graded) {
    var _a;
    const audio = view.plugin.settings.audio;
    if (!(audio === null || audio === void 0 ? void 0 : audio.enabled))
        return;
...
function renderActionRow(view, footer, card, graded) {
    ...
    const moreMenu = attachWidgetMoreMenu({
        ...
        openNote: () => {
            ...
            const c = (_a = view.currentCard) === null || _a === void 0 ? void 0 : _a.call(view);
            if (!c)
                return;
            const isFolderScope = ((_b = view.session) === null || _b === void 0 ? void 0 : _b.scopeType) === "folder";
            const filePath = (isFolderScope ? c.sourceNotePath : (_c = view.session) === null || _c === void 0 ? void 0 : _c.scopeKey) || c.sourceNotePath || ((_d = view.activeFile) === null || _d === void 0 ? void 0 : _d.path);
            if (!filePath)
                return;
            if (isFolderScope) {
                void openCardAnchorInNote(view.app, filePath, String((_e = c.id) !== null && _e !== void 0 ? _e : ""));
                return;
            }
            ...
            const preferredLeaf = markdownLeaves.find((leaf) => {
                ...
                return markdownView instanceof MarkdownView && ((_a = markdownView.file) === null || _a === void 0 ? void 0 : _a.path) === filePath;
            });
            void openCardAnchorInNote(view.app, filePath, String((_f = c.id) !== null && _f !== void 0 ? _f : ""), {
                openInNewLeaf: false,
                preferredLeaf,
            });
        },
...
function renderProgressBar(view, wrap) {
    var _a, _b, _c, _d;
    const progressBar = el("div", "sprout-widget-progress");
    const total = Math.max(0, ((_b = (_a = view.session) === null || _a === void 0 ? void 0 : _a.stats) === null || _b === void 0 ? void 0 : _b.total) || 0);
    const done = Math.max(0, ((_d = (_c = view.session) === null || _c === void 0 ? void 0 : _c.stats) === null || _d === void 0 ? void 0 : _d.done) || 0);
