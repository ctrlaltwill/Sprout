...
import { AOS_CASCADE_STEP, } from "../../platform/core/constants";
import { setCssProps } from "../../platform/core/ui";
import { applyStickyThStyles, } from "./browser-helpers";
...
// ── applyAos helper ───────────────────────────────────────
function makeAosFn(animationsEnabled) {
    let cascadeDelay = 0;
 ...
 */
export function buildBrowserLayout(root, ctx) {
    var _a;
    const { applyAos } = makeAosFn(ctx.animationsEnabled && ((_a = ctx.internalAosEnabled) !== null && _a !== void 0 ? _a : true));
    const tx = (token, fallback, vars) => { var _a, _b; return t((_b = (_a = ctx.plugin.settings) === null || _a === void 0 ? void 0 : _a.general) === null || _b === void 0 ? void 0 : _b.interfaceLanguage, token, fallback, vars); };
    const uiCleanups = [];
    // ── Toolbar / filters ──
    ...
    // Stage filter
    const stageDd = makeDropdownMenu({
    ...
    const headCell = (label, key) => {
        ...
        th.addEventListener("click", (ev) => {
            ...
            if ((_a = target === null || target === void 0 ? void 0 : target.closest) === null || _a === void 0 ? void 0 : _a.call(target, ".learnkit-col-resize")) {
                ev.preventDefault();
                ev.stopPropagation();
                return;
            }
    ...
    const pageSizeDd = makeDropdownMenu({
