...
export function normaliseSettingsInPlace(s: SproutSettings): void {
  ...
  s.noteReview.avoidFolderNotes = s.noteReview.avoidFolderNotes ?? DEFAULT_SETTINGS.noteReview.avoidFolderNotes;
  s.noteReview.filterQuery = String(s.noteReview.filterQuery ?? DEFAULT_SETTINGS.noteReview.filterQuery);
  s.noteReview.reviewsPerDay = clamp(
    Number(s.noteReview.reviewsPerDay ?? DEFAULT_SETTINGS.noteReview.reviewsPerDay),
    1,
    5000,
  );
  s.noteReview.reviewStepsDays = cleanPositiveNumberArray(
    s.noteReview.reviewStepsDays,
    DEFAULT_SETTINGS.noteReview.reviewStepsDays,
  );
