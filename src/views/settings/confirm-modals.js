...
function tx(locale, token, fallback, vars) {
    return t(locale, token, fallback, vars);
}
function styleConfirmActionButton(button, kind = "default") {
    button.type = "button";
    ...
    if (kind === "danger")
        button.classList.add("learnkit-btn-danger", "learnkit-btn-danger");
}
function initConfirmModal(modal, title) {
...
export class BackupCompareModal extends Modal {
    constructor(app, backup, current, locale) {
        super(app);
        this.backup = backup;
...
export class ConfirmRestoreBackupModal extends Modal {
    constructor(app, plugin, backup, current, onRestored) {
        super(app);
        this.plugin = plugin;
        this.backup = backup;
        this.current = current;
    ...
    onOpen() {
        ...
        add(tx(locale, "ui.settings.modals.restoreBackup.row.analytics", "Analytics events"), (_c = this.current.analyticsEvents) !== null && _c !== void 0 ? _c : 0, (_d = this.backup.analyticsEvents) !== null && _d !== void 0 ? _d : 0);
...
export class ConfirmDeleteBackupModal extends Modal {
    constructor(app, plugin, backup, onDone) {
        super(app);
        this.plugin = plugin;
        this.backup = backup;
        this.onDone = onDone;
    ...
    onOpen() {
        ...
        deleteBtn.onclick = async () => {
            ...
            try {
                ...
                (_a = this.onDone) === null || _a === void 0 ? void 0 : _a.call(this);
            }
            catch (e) {
                log.error(e);
