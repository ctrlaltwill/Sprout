 ...
 */
export function createYAxisTicks(maxValue) {
...
export function createXAxisTicks(startIndex, endIndex, todayIndex) {
...
export function formatAxisLabel(dayIndex, todayIndex, labelFormatter) {
