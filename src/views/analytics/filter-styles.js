...
export function useAnalyticsPopoverZIndex(open, wrapRef) {
    React.useEffect(() => {
        var _a;
        const card = (_a = wrapRef.current) === null || _a === void 0 ? void 0 : _a.closest(".learnkit-ana-card");
        if (!card)
            return;
        ...
        if (open) {
            ...
            if (grid)
                grid.setAttribute("data-popover-open", "true");
        }
        else {
