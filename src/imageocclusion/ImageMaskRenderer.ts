...
import { IOParentDef, IORect, IOMaskMode } from "./ImageOcclusionTypes";
import { clampRectPx, normToPxRect, pxToNormRect, rectPxFromPoints, type RectPx } from "./ImageGeometry";
import { applyStageTransform, clientToStage, zoomAt, type StageTransform } from "./ImageTransform";
import { 
  isMaskMode, 
  makeRectId, 
  nextAutoGroupKey, 
