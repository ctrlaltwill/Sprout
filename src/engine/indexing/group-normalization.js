...
function pickCanonicalGroupVariant(variants) {
...
export function buildCanonicalGroupCaseMap(rawGroups) {
    const variantsByLowerKey = new Map();
    let seenIndex = 0;
    ...
    const canonicalByLowerKey = new Map();
...
export function canonicalizeGroups(rawGroups) {
